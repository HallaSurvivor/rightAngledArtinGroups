...
%%%%
% Just in case I need this one day, I want to put it in the latex file!
% I haven't double checked these, I'm just reading them off the sheet of 
% paper from a day or two ago when I came up with these examples!
% In case you REALLY need them, you'll want to use this as a guide to 
% make sure everything works out, and you're not off by an inverse somewhere.
% But even having this amount of a guide will help a LOT, haha
%
% G = <x1, x2, x3, x4> is the raag A(a-b). 
%
% x1 = b 
% x2 = extra variable
% x3 = [a,b]^{-1}
% x4 = ab
% 
% relation 1 says x3 = [a,b]^{-1}
% relations 2 and 3 force x2 = x3 = e
%
%
% H = <y1, y2, y3, y4, y5> is the raag A(p-q-r)
%
% y1 = r 
% y2 = [p,q]^{-1}
% y3 = q
...
% y5 = p
%
% relations 11 and 22 force y2=y4=e 
% relations 12 and 21 show y2/y4 are the commutators as above
%
% This means that phi is the map induced by 
% a |--> q 
% b |--> r
%
% and psi is the map induced by 
% a |--> qr^{-1}
% b |--> r
%%%%
...
\bibliography{descent-raags.bib}
