...
\todo{graphs should be roman and groups should be greek}
...
\important{(Co)Monadicity Theorem} \todo{cite something here}, which says
...
\todo{cite the original. This is also apparently thm 2.7 in Koberda's raag course}
