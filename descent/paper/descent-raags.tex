...
\label{intro}
  ...
  $3$-manifolds \todo{there might be a better citation for this}\cite{servatiusSURFACESUBGROUPSGRAPH} 
  ...
  bonus data.\todo{rewrite the abstract to push this as the punchline}
...
\begin{proof}
    ...
    of $G$, 
    and the claim now follows from the fact that $ACH$ is a raag, and thus
