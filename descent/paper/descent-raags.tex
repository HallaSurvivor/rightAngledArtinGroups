...
\end{abstract}
\todo{Is this abstract too long? How would you write it?}
...
\label{intro}
  ...
  group homomorphisms between raags. In particular, is there a purely 
  algebraic way to recognize when a group homomorphism between raags is 
  $A \varphi$ for some homomorphism $\varphi$ of their underlying graphs.
...
(TODO: add a paragraph saying that, in the case of the adjunction between 
$R$ and $S$ modules, we recover the usual notion of coalgebra, with a 
map $S \to S \otimes_R S$.)
